...
var ActionListComponent = (function () {
    function ActionListComponent(fhirService, patientService, compiler) {
    ...
    ActionListComponent.prototype.loadPatients = function () {
        var _this = this;
    ...
    ActionListComponent.prototype.total = function () {
        var t = 0;
        if (this.patients) {
    ...
    ActionListComponent.prototype.select = function (id) {
        var _this = this;
    ...
    ActionListComponent.prototype.selectServer = function (server) {
        console.log("Setting server to: " + server.url);
        this.server = server;
        this.fhirService.setUrl(server.url);
        this.loadPatients();
    };
    ActionListComponent.prototype.selectServerForUrl = function (url) {
        this.selectServer(this.serverFor(url));
    };
    ActionListComponent.prototype.serverFor = function (url) {
        var obj = null;
    ...
    ActionListComponent.prototype.genderString = function (patient) {
        var s = 'Unknown';
    ...
    ActionListComponent.prototype.selectCondition = function (condition) {
...
ActionListComponent = __decorate([
    core_1.Component({
        selector: 'actionList',
        templateUrl: 'app/components/actionList.html'
    }),
