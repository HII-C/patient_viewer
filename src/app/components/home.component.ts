...
export class HomeComponent {
	...
	gridConfiguration: NgGridConfig = <NgGridConfig>{
		...
		'min_width': 1,           //  The minimum width of an item. If greater than col_width, this will update the value of min_cols
		'min_height': 1,          //  The minimum height of an item. If greater than row_height, this will update the value of min_rows
